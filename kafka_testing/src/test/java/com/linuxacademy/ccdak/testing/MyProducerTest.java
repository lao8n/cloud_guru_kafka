...
public class MyProducerTest {
  ...
  public void testPublishRecord_sent_data(){
    // Perform a simple test to verify that the producer sends the correct 
    // data to the correct topic when publishRecord is called
    ...
    // getting weird extra [] at the end with a line break in between not sure why
